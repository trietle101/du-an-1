        ...
        <nav class="header-nav">
          <div class="container-fixed">
            ...
            <ul class="nav__list">
              ...
              <li class="nav__item">
                <a href="./assets/shop.html" class="nav__link">Robo shop</a>
              </li>
              <li class="nav__item">
          ...
          <div class="outstanding-list">
            <div class="outstanding-item">
              <div class="outstanding-main">
                ...
                <div class="outstanding-content">
                  <ul class="outstanding-social">
                    <li class="outstanding-social-item">
                      <a class="outstanding-social-link" href="./delital.html"
                ...
                <div class="outstanding-info">
                  <h4 class="outstanding-name">Eilik Blue</h4>
            ...
            <div class="outstanding-item">
              <div class="outstanding-main">
                <img
                  class="outstanding-image"
                  src="assets/img/outstanding/img eillik/eilick pink.png"
                  alt=""
                />
                <div class="outstanding-content">
                  <ul class="outstanding-social">
                    <li class="outstanding-social-item">
                      <a class="outstanding-social-link" href="#Chiristopher"
                        ><i class="fas fa-search"></i
                      ></a>
                    </li>
                    <li class="outstanding-social-item">
                ...
                <div class="outstanding-info">
                  <h4 class="outstanding-name">Eilik Pink</h4>
                  <div class="outstanding-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="outstanding-item">
              <div class="outstanding-main">
                <img
                  class="outstanding-image"
                  src="assets/img/outstanding/img emo/emo.png"
                  alt=""
                />
                <div class="outstanding-content">
                  <ul class="outstanding-social">
                ...
                <div class="outstanding-info">
                  <h4 class="outstanding-name">Emo</h4>
                  <div class="outstanding-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="outstanding-item">
              <div class="outstanding-main">
                <img
                  class="outstanding-image"
                  src="assets/img/outstanding/img vector/vector.png"
                  alt=""
                />
                <div class="outstanding-content">
                  <ul class="outstanding-social">
                ...
                <div class="outstanding-info">
                  <h4 class="outstanding-name">Vector</h4>
                  <div class="outstanding-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
          ...
          <div class="custum-list">
            <div class="custum-item">
              <div class="custum-main">
                <img
                  class="custum-image"
                  src="assets/img/row costumes/costumes1.png"
                  alt=""
                />
                <div class="custum-content">
                  <ul class="custum-social">
                    <li class="custum-social-item">
                      <a class="custum-social-link" href="#Chiristopher"
                        ><i class="fas fa-search"></i
                      ></a>
                    </li>
                    <li class="custum-social-item">
            ...
            <div class="custum-item">
              <div class="custum-main">
                <img
                  class="custum-image"
                  src="assets/img/row costumes/costumes2.png"
                  alt=""
                />
                <div class="custum-content">
                  <ul class="custum-social">
                ...
                <div class="custum-info">
                  <h4 class="custum-name">Dairy cow</h4>
                  <div class="custum-price">
                    <span>$18.99</span>
                  </div>
                </div>
            ...
            <div class="custum-item">
              <div class="custum-main">
                <img
                  class="custum-image"
                  src="assets/img/row costumes/costumes3.png"
                  alt=""
                />
                <div class="custum-content">
                  <ul class="custum-social">
            ...
            <div class="custum-item">
              <div class="custum-main">
                <img
                  class="custum-image"
                  src="assets/img/row costumes/costumes4.png"
                  alt=""
                />
                <div class="custum-content">
                  <ul class="custum-social">
