      ...
      <div class="container">
        <div class="detail-box">
          <div class="detail-image">
            <img
              src="./img/AI/img eillik/image_3__5_-removebg-preview.png"
              alt=""
            ...
            <div class="detail-image-list">
              <img
                src="./img/AI/img eillik/image_3__5_-removebg-preview.png"
                alt=""
                class="detail-image-item active"
              />
              <img
              ...
              />
              <img
                src="./img/AI/img eillik/Frame_1__92_-removebg-preview.png"
                alt=""
                class="detail-image-item"
              />
              <img
          ...
          <div class="detail-info">
            <h3 class="detail-info-name">Eilik BLue</h3>
            <div class="detail-info-price">
              <span>$139.99</span>
              <del>$150.99</del>
            </div>
            <p class="detail-info-desc">
              A Little Companion Bot with Endless Fun.
            </p>
          ...
          <div class="outstanding-list">
            ...
            <div class="outstanding-item">
              <div class="outstanding-main">
                <img
                  class="outstanding-image"
                  src="./img/outstanding/img emo/emo.png"
                  alt=""
                />
                <div class="outstanding-content">
                  <ul class="outstanding-social">
