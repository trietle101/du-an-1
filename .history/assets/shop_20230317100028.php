    ...
    <section class="products">
      <div class="container">
        <div class="products-product">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown__list">
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/shop.php?id_pd=2' ?>" class="dropdown__text">Emo</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/shop.php?id_pd=1' ?>" class="dropdown__text">Eilik</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/shop.php?id_pd=3' ?>" class="dropdown__text">Vector</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/shop.php?id_pd=4' ?>" class="dropdown__text">Accessories</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/shop.php?id_pd=all' ?>" class="dropdown__text">All</a>
                      </li>
                    </ul>
                  </div>
            </div>
          ...
          <?php
            if(isset($_GET['id_pd']) && $_GET['id_pd'] == 'all'){
            ...
            <div class="products-item">
              ...
              <?php }?>
                <?php } elseif(isset($_GET['is_pd'])){
                  $productsCate = products_selectID_cate($_GET['is_pd']);
                  ?>
                  <?php
