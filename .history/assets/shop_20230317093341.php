                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown__list">
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/detail.php?id_pd=2' ?>" class="dropdown__text">Emo</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/detail.php?id_pd=1' ?>" class="dropdown__text">Eilik</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/detail.php?id_pd=3' ?>" class="dropdown__text">Vector</a>
                      </li>
                      <li class="dropdown__item">
                        <a href="<?php echo '../assets/detail.php?id_pd=4' ?>" class="dropdown__text">Accessories</a>
                      </li>
                    </ul>
                  </div>
            </div>
