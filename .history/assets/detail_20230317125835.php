      ...
      <div class="container">
        <div class="detail-box">
          ...
          <div class="detail-info">
            ...
            <hr />
            <?php
            $cate = products_selectID_cate($_GET['id_pd']);
            if(isset($_GET['id_pd']) && $cate[0][8] == '1'){
              ?>
              <img
            ...
            <?php }?>
            <?php
            if(isset($_GET['id_pd']) && $cate[0][8] == '2'){
              ?>
              <img
            ...
            <?php }?>
            <?php
            if(isset($_GET['id_pd']) && $cate[0][8] == '3'){
              ?>
              <img
            ...
            <?php }?>
            <?php
            if(isset($_GET['id_pd']) && $cate[0][8] == '4'){
              ?>
              <img
                src="./img/Eilik/item_gif.gif"
                alt=""
