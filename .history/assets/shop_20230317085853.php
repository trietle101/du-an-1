          ...
          <div class="products-list">
            <div class="products-item">
              <div class="products-main">
                ...
                <div class="products-content">
                  <ul class="products-social">
                    <li class="products-social-item">
                      <a class="products-social-link" href="./detail.html"
                ...
                <div class="products-info">
                  <h4 class="products-name">Eilik Blue</h4>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="./img/outstanding/img eillik/eilick pink.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                    <li class="products-social-item">
                      <a class="products-social-link" href="#Chiristopher"
                        ><i class="fas fa-search"></i
                      ></a>
                    </li>
                    <li class="products-social-item">
                ...
                <div class="products-info">
                  <h4 class="products-name">Eilik Pink</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img emo/image 4.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img vector/vector.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Vector Black</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img vector/Frame_1__87_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Vector Blue</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img vector/Frame_1__85_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Vector White</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img vector/Frame_1__77_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Vector</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img emo/Frame_1__69_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Emo Home</h4>
                  <div class="products-price">
                    <span>$139.99</span>
                    <del>$150.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img emo/Frame_1__59_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Shipa</h4>
                  <div class="products-price">
                    <span>$18.99</span>
                    <del>$20.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/outstanding/img emo/Frame_1__63_-removebg-preview.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Dairy Cow</h4>
                  <div class="products-price">
                    <span>$18.99</span>
                    <del>$20.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/row costumes/costumes3.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Noel</h4>
                  <div class="products-price">
                    <span>$18.99</span>
                    <del>$20.99</del>
                  </div>
            ...
            <div class="products-item">
              <div class="products-main">
                <img
                  class="products-image"
                  src="././img/row costumes/costumes6.png"
                  alt=""
                />
                <div class="products-content">
                  <ul class="products-social">
                ...
                <div class="products-info">
                  <h4 class="products-name">Pink</h4>
                  <div class="products-price">
                    <span>$18.99</span>
                    <del>$20.99</del>
                  </div>
