          ...
          <table class="cart-table">
            ...
            <tbody>
                    ...
                    foreach($_SESSION['cart'] as $cart){
                      ...
                      foreach($listProducts as $item){
                        ...
                        <tr class="item">
                          ...
                          <td>
                            <img src="<?php echo $item[0][4] ?>" alt="" />
                          </td>
                          <td><h5><?php echo $item[0][1] ?></h5></td>
                          <td><h5>$<?php echo $item[0][3] ?></h5></td>
                          <td>
                            <button class="cart-prev">
                              <i class="fas fa-minus"></i>
                            </button>
                            <input type="number" name="" value="<?php echo $_SESSION['cart'][$item[0]]["quantity"] ?>" class="input-number" />
                            <button class="cart-next">
                              <i class="fas fa-plus"></i>
                            </button>
                          </td>
                          <td><h5>$<?php echo $_SESSION['cart'][$item[0]]["total"] ?></h5></td>
                        </tr>
                      <?php } ?>
                    <?php }?>
                <?php } ?>
              <tr class="item">
                ...
                <td>
                  <img src="./img/outstanding/img emo/emo.png" alt="" />
                </td>
                <td><h5>Emo</h5></td>
                <td><h5>$279.99</h5></td>
                <td>
                  ...
                  <input type="number" name="" value="2" class="input-number" />
                  <button class="cart-next">
                    <i class="fas fa-plus"></i>
                  </button>
                </td>
              ...
              <tr class="item">
                ...
                <td>
                  <img
                    src="././img/AI/img eillik/Frame_1__89_-removebg-preview.png"
                    alt=""
                  />
                </td>
                <td><h5>Eilik Blue</h5></td>
                <td><h5>$139.99</h5></td>
                <td>
                  <button class="cart-prev">
                    <i class="fas fa-minus"></i>
