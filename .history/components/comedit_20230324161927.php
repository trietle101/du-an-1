  ...
  if(isset($_POST['edit_pd'])){
    if(isset($_POST['id_pd'])){
      ...
      if($newImage){
          ...
          update_products($_POST['id_pd'], $name, $price, $price_sale, $target_file, $date, $quantity, $cate);
      }else{
        update_not_img($_POST['id_pd'], $name, $price, $price_sale, $date, $quantity, $cate);
      }
                  ...
                  <div class="checkout-address-list">
                    <div class="checkout-address-item">
                      ...
                      <div class="checkout-address-input">
                        ...
                        <input type="number" name="product" value="<?php echo $products[0][1] ?>">
                      </div>
                    </div>
                    <div class="checkout-address-item">
                      <div class="checkout-address-input">
                      ...
                      <div class="checkout-address-input">
                        <input type="submit" value="Add" class="submit" name="add-img"/>
                      </div>
                    </div>
                  </div>
                </form>
