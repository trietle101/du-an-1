<?php
    ...
    function update_not_img($id_pd, $name, $price, $price_sale, $quantity, $id_cate){
        $sql = 'UPDATE products SET name_pd = ?, price = ?, price_sale = ?, Quantity = ?, id_cate = ? WHERE id_pd = ?';
        pdo_execute($sql, $name, $price, $price_sale, $quantity, $id_cate, $id_pd);
    }
?>