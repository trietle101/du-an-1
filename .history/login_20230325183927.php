        ...
        <form action="login.php" method="POST">
          ...
          <?php
            if(isset($email_err) && $email_err != ''){
              ?>
              <p style="color: red; fontsize: 12px"><?php echo $email_err ?></p>
            <?php }?>
          <input type="number" placeholder="Phone" name="phone" id="phone"/>
          <?php
            if(isset($phone_err) && $phone_err != ''){
              ?>
              <p style="color: red; fontsize: 12px"><?php echo $phone_err ?></p>
            <?php }?>
          <input type="password" placeholder="Password" name="pass" id="pass"/>
          <?php
            if(isset($pass_err) && $pass_err != ''){
              ?>
              <p style="color: red; fontsize: 12px"><?php echo $pass_err ?></p>
            <?php }?>
          ...
          <?php
            if(isset($confirm) && $confirm != ''){
              ?>
              <p style="color: green;"><?php echo $confirm ?></p>
            <?php }?>
        </form>
      </div>
