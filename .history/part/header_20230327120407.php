          ...
          <div class="container-fixed">
            ...
            <div class="header-menu">
              <ul class="nav__list">
                ...
                <li class="nav__item">
                  <a href="./shop.php" class="nav__link <?php if($_SERVER['PHP_SELF'] == '/assets/shop.php' || $_SERVER['PHP_SELF'] == '/assets/detail.php' || $_SERVER['PHP_SELF'] == '/assets/cart.php' ) {echo 'active';} ?>">Robo shop</a>
                </li>
                <li class="nav__item">
