          ...
          <div class="container-fixed">
            ...
            <div class="header-menu">
              <ul class="nav__list">
                ...
                <li class="nav__item">
                  <a href="./shop.php" class="nav__link <?php if($_SERVER['PHP_SELF'] == '/assets/shop.php') {echo 'active';} ?>">Robo shop</a>
                </li>
                <li class="nav__item">
                  <a href="./blog.php" class="nav__link <?php if($_SERVER['PHP_SELF'] == '/assets/blog.php') {echo 'active';} ?>">Blogs</a>
                </li>
                <li class="nav__item">
                  <a href="./contact.php" class="nav__link <?php if($_SERVER['PHP_SELF'] == '/assets/contact.php') {echo 'active';} ?>">Contact</a>
                </li>
              </ul>
              <ul class="nav__list">
                <li class="nav__item">
